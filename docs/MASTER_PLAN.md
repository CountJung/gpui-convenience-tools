...
범위 선택 상호작용은 VDE-018~019의 픽스처/실행 검증에 남겼다.
...
내부 중지 지점은 VDE-018~019에서 고정 이미지로 확인한다.
...
한 키보드 E2E와 독립 Visual Reviewer 검증은 VDE-018~019에 남겼다.
...
필요하므로 VDE-018~019에서 고정 이미지/도구 픽스처로 이어간다.
