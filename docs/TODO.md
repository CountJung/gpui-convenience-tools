...
<!-- decision-task-ids: D-007,D-008,D-014,D-015,D-016,VDE-019,VDE-021,D-020,G-001,K-001,K-002,K-003,K-004,K-005,E-001,E-002,E-003,E-004 -->

- `D-007`~`D-008`: D-006 측정 결과에 따라 사전 스캔 기반 전체 수와 진행률 바를 구현한다.
