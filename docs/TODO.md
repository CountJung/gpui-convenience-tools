...
이관했다. 사전 순회 기반 전체 수·진행률 표시도 완료되어 다음 미완료 항목은 D-014다.
...
`SyncProgress.total` 사전 순회, 백그라운드 이벤트 전달, 하단 진행률 바와 compact 높이
레이아웃 회귀 검증은 `VERIFICATION.md`와 `MASTER_PLAN.md`에 완료 근거를 남겼다.
...
<!-- decision-task-ids: D-014,D-015,D-016,VDE-019,VDE-021,D-020,G-001,K-001,K-002,K-003,K-004,K-005,E-001,E-002,E-003,E-004 -->
